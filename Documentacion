...
**Music App** es una aplicación web sencilla que permite a los usuarios iniciar sesión con su nombre de usuario y contraseña, escoger su plan de subscripcion ya sea individual o premium, agregar canciones y reproducirlas, y crear playlists. De igual manera cada cancion podrá pausarse, regresarse o adelantarse. 
...
El usuario escoge su plan de subscripción.
Si las credenciales son válidas, se redirige al área principal de reproducción de canciones.

### 2. Pantalla de Reproducción
Una vez dentro, el usuario puede:
- Agregar canciones nuevas
- Crear playlists
- Reproducir canciones existentes
- Pausar, adelantar o retroducer las canciones en su playlist
- Visualizar las canciones y las playlist
- Visualizar su plan de subscripcion
...
El propósito de este proyecto es **comprender e implementar la comunicación entre el frontend, el backend y la base de datos**, logrando una aplicación funcional con inicio de sesión y manejo básico de reproductor de canciones.
...
### Pantalla de Login
![Pantalla de login](imagenes/loginInterface.png)

### Pantalla de Reproducción de Música
![Pantalla de login](imagenes/music.png)
...
![Pantalla de login](imagenes/dataBtables.jpg)
![Pantalla de login](imagenes/DataB.jpg)
---
