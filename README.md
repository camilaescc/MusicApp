...
Este proyecto tiene como objetivo simular el desarrollo de una aplicación de tipo spotify. El propósito que se busca con este proyecto es aprender a gestionar las herramientas que suelen utilizarse para el desarrollo de aplicaciones siguiendo roles definidos:
...
1. Reproducir una cancion
2. Pausar una cancion
3. Regresar hacia una cancion
4. Saltar hacia la siguiente cancion
5. Ver el plan de subscripcion del usuario
6. Agregar playlists
